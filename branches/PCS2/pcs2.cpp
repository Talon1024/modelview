...
wxString PCS2_SUPPORTED_FORMATS = "All Supported Formats|*.cob;*.pmf;*.pof;*.scn|Parallax Object Files (.pof)|*.pof|PCS2 Model File (.pmf)|*.pmf|Caligari Object Binary (.cob)|*.cob|Caligari Scene (.scn)|*.scn";
...
void PCS2_MainWindow::on_global_import(wxCommandEvent &event){
	wxFileDialog fdlg(NULL, "Select Import File", "", "", "All Supported Formats|*.cob;*.pmf;*.pof;*.scn|Parallax Object Files (.pof)|*.pof|PCS2 Model File (.pmf)|*.pmf|Caligari Object Binary (.cob)|*.cob|Caligari Scene (.scn)|*.scn", 
