...
#define DMREG_GAMETYPE_DESCENT1	1
#define DMREG_GAMETYPE_DESCENT2	2
#define DMREG_GAMETYPE_DESCENT3	3
#define DMREG_GAMETYPE_FREESPACE1	5
#define DMREG_GAMETYPE_FREESPACE2	6
#define DMREG_GAMETYPE_SUMMONER1	9
